...
exports.RedisValueHelper = void 0;
const redis = __importStar(require("redis"));
const util_1 = require("util");
class RedisValueHelper {
    constructor(config) {
    ...
    getCached(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const data = yield this._getAsync(`${this._prefix}:${key}`);
                if (data) {
    ...
    getCacheds(keys) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const key of keys) {
                const cached = yield this.getCached(key);
                if (cached) {
                    cacheds.push(cached);
                }
            }
    ...
    setCached(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield this._setAsync(key, this._ttl, JSON.stringify(value));
            }
            catch (e) {
            }
        });
...
exports.RedisValueHelper = RedisValueHelper;
//# sourceMappingURL=redis_value_helper.js.map